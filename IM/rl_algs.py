...
class DQN:
    def __init__(self, gnn_input=40, state_dim=2, ff_hidden=128, epsilon_min=0.05, decay_rate=0.9995, batch_size=512, gamma=0.995, max_memory=10000, tau=0.0025, cuda=True):
